...
2) read in data for each subject using purrr::map and saving the result as a new variable in the dataframe) 


read in data using map 
save result as new variable in dataframe 
